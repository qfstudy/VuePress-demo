...
export default {
  ...
  created(){
    //将字符串分割成数组
    this.proString=this.$props.description
    this.content=this.proString.split('*')
    this.extendedString=this.$props.extendedDescription
    this.extendedContent=this.extendedString.split('*')
    // console.log(this.content)
    // console.log(this.proString)
    // console.log(this.extendedContent)
  }
}
</script>
